                            ...
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    ...
                                    <ul class="name-box clearfix">
                                        <li class="name"><h2>Dr. {{$doctor->last_name .' '. $doctor->first_name}}</h2></li>
                                        {{-- Check if Doctor if verified --}}
                                        @if ($doctor->verified)
                                            <li><i class="icon-Trust-1"></i></li>
                                        @endif
                                        {{-- Check if Doctor if garanteed --}}
                                        @if ($doctor->garanteed)
                                    ...
                                    <div class="lower-box clearfix">
                                        <ul class="info clearfix">
                                            ...
                                            <li><i class="fas fa-phone"></i><a href="tel:{{$doctor->phone}}">{{$doctor->phone}}</a></li>
                                        </ul>
                                        <div class="view-map"><a href="#">View Map</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tabs-box">
                            ...
                            <div class="tabs-content">
                                <div class="tab active-tab" id="tab-1">
                                    <div class="inner-box">
                                        <div class="text">
                                            <h3>About Dr. {{$doctor->last_name .' '. $doctor->first_name}}:</h3>
                                            <p>{{$doctor->bio}}</p>
                                            <h3>Specialities</h3>
                                ...
                                <div class="tab" id="tab-3">
                                    <div class="location-box">
                                        ...
                                        <ul class="location-info clearfix">
                                            <li><i class="fas fa-map-marker-alt"></i>{{$doctor->address}}<br/></li>
                                            <li><i class="fas fa-phone"></i><a href="tel:{{$doctor->phone}}">{{$doctor->phone}}</a></li>
                                        </ul>
                                    </div>
                                </div>
